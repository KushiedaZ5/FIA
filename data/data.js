    ...
    'ingSistemas': {
        ...
        ciclos: {
            ...
            'ciclo6': [
                ...
                { value: 'teoria_sistemas', text: 'Teoría General de Sistemas (Proximamente...)', esquema: '046' },
            ]
        }
    },
    'ingCivil': {
        ...
        ciclos: {
            ...
            'ciclo2': [
                ...
                { value: 'diseño_grafico', text: 'Dibujo y Diseño Gráfico(Proximamente...)', esquema: '045' },
                { value: 'intro_economia', text: 'Introducción a la Economía', esquema: '038' },
                { value: 'topografia', text: 'Topografía(Proximamente...)', esquema: '128' },
                { value: 'geologia_general', text: 'Geología General(Proximamente...)', esquema: '128' },
            ],
            'ciclo3': [
                { value: 'calculo2', text: 'Calculo II', esquema: '040' },
                { value: 'est1', text: 'Estadística y Probabilidades I', esquema: '041' },
                { value: 'fis1', text: 'Física I', esquema: '042' },
                { value: 'quimicage', text: 'Química General', esquema: '043' },
                { value: 'tecnologia_materiales', text: 'Tecnología de los materiales', esquema: '046' },
                { value: 'topoavanzada', text: 'Topografía Avanzada', esquema: '045' }],
            'ciclo4': [
                ...
                { value: 'construccion1_civil', text: 'Construcción 1', esquema: '045' },
                { value: 'ec_diferenciales_civil', text: 'Ecuaciones Diferenciales', esquema: '040' },
                { value: 'fis2', text: 'Física 2', esquema: '042' },
            ],
            'ciclo5': [
                { value: 'contabilidad_general', text: 'Contabilidad General', esquema: '038' },
                { value: 'construccion2_civil', text: 'Construcción II(Proximamente...)', esquema: '046' },
                { value: 'caminos1', text: 'Caminos I(Proximamente...)', esquema: '045' },
                { value: 'resistencia_materiales1', text: 'Resistencia de Materiales I(Proximamente...)', esquema: '129' },
                { value: 'ecologia_impacto', text: 'Ecología e Impacto Ambiental(Proximamente...)', esquema: '043' },
                { value: 'instalaciones_electricas', text: 'Instalaciones Eléctricas en Edificaciones(Proximamente...)', esquema: '042' },
            ],
            'ciclo6': [
                { value: 'mecanica_fluidos1', text: 'Mecánica de Fluidos I(Proximamente...)', esquema: '038' },
                { value: 'pavimentos', text: 'Pavimentos(Proximamente...)', esquema: '128' },
                { value: 'gestion_financiera', text: 'Gestión Financiera(Proximamente...)', esquema: '038' },
                { value: 'mecanica_suelos1', text: 'Mecánica de Suelos I(Proximamente...)', esquema: '046' },
                { value: 'resistencia_materiales2', text: 'Resistencia de Materiales II(Proximamente...)', esquema: '046' },
            ]
        }
    },
    'ingIndustrial': {
    ...
    'arquitectura': {
        ...
        ciclos: {
            'ciclo1': [
                ...
                { value: 'lenguaje', text: 'Lenguaje', esquema: '049' },
                { value: 'metodos_est', text: 'Métodos de Estudio', esquema: '049' },
                { value: 'taller1', text: 'Taller I(Proximamente...)', esquema: '045' },
                { value: 'matematica1', text: 'Matemática I(Proximamente...)', esquema: '040' },
                { value: 'exp_arq1', text: 'Expresión Arquitectónica I(Proximamente...)', esquema: '040' },
                { value: 'ingles1', text: 'Inglés 1', esquema: '039' },
            ], 'ciclo2': [
                { value: 'geom_des', text: 'Geometría Descriptiva(Proximamente...)', esquema: '049' },
                { value: 'matematica2', text: 'Matemática II(Proximamente...)', esquema: '049' },
                { value: 'taller2', text: 'Taller II(Proximamente...)', esquema: '045' },
                { value: 'exp_arq2', text: 'Expresión Arquitectónica II(Proximamente...)', esquema: '040' },
                { value: 'topografia', text: 'Topografía(Proximamente...)', esquema: '040' },
                { value: 'ingles2', text: 'Inglés 2', esquema: '039' },
            ], 'ciclo3': [
                { value: 'const1', text: 'Construcción 1(Proximamente...)', esquema: '129' },
                { value: 'exp_arq3', text: 'Expresión Arquitectónica 3(Proximamente...)', esquema: '038' },
                { value: 'estruc1_arq', text: 'Estructuras 1(Proximamente...)', esquema: '038' },
                { value: 'taller3_arq', text: 'Taller 3(Proximamente...)', esquema: '127' },
                { value: 'fisica1', text: 'Física General I(Proximamente...)', esquema: '038' },
            ],
            'ciclo4': [
            ...
            'ciclo5': [
                { value: 'const3', text: 'Construcción 3(Proximamente...)', esquema: '129' },
                { value: 'urb1', text: 'Urbanismo I(Proximamente...)', esquema: '038' },
                { value: 'bio1', text: 'Diseño Bioclimático I(Proximamente...)', esquema: '038' },
                { value: 'taller5_arq', text: 'Taller 5(Proximamente...)', esquema: '127' },
                { value: 'hist1', text: 'Historia de la Arquitectura I(Proximamente...)', esquema: '038' },
                { value: 'discapacidad_inclusion', text: 'Discapacidad e Inclusión(Proximamente...)', esquema: '038' }
            ], 'ciclo6': [
                { value: 'inst_sanitarias', text: 'Instalaciones Sanitarias y Electromecánicas(Proximamente...)', esquema: '129' },
                { value: 'urb2  ', text: 'Urbanismo II(Proximamente...)', esquema: '038' },
                { value: 'bio2', text: 'Diseño Bioclimático II(Proximamente...)', esquema: '038' },
                { value: 'taller6_arq', text: 'Taller 6(Proximamente...)', esquema: '127' },
                { value: 'hist2', text: 'Historia de la Arquitectura II(Proximamente...)', esquema: '038' },
                { value: 'liderazgo_oratoria', text: 'Liderazgo y Oratoria(Proximamente...)', esquema: '038' }
            ]
        }
    },
    'aeronautica': {
        ...
        ciclos: {
            'ciclo1': [
                ...
                { value: 'realidad_nacional', text: 'Realidad Nacional(Proximamente...)', esquema: '045' },
                { value: 'introduccion_aviacion', text: 'Introducción a la Aviación(Proximamente...)', esquema: '040' },
                { value: 'metereologia1', text: 'Metereología I(Proximamente...)', esquema: '040' },
                { value: 'ingles1', text: 'Inglés 1', esquema: '039' },
                { value: 'lenguaje', text: 'Lenguaje(Proximamente...)', esquema: '039' },
                { value: 'regulaciones_1', text: 'Regulaciones Aéreas I(Proximamente...)', esquema: '039' },
            ], 'ciclo2': [
                { value: 'fisica2', text: 'Física General II(Proximamente...)', esquema: '049' },
                { value: 'matematica2', text: 'Matemática II(Proximamente...)', esquema: '049' },
                { value: 'operaciones_piloto_privado', text: 'Operaciones de Piloto Privado(Proximamente...)', esquema: '049' },
                { value: 'aerodinamica', text: 'Aerodinámica(Proximamente...)', esquema: '045' },
                { value: 'factores_humanos_aviacion', text: 'Factores Humanos en Aviación(Proximamente...)', esquema: '040' },
                { value: 'performance_aeronaves1', text: 'Performance de Aeronaves I(Proximamente...)', esquema: '040' },
                { value: 'ingles2', text: 'Inglés 2', esquema: '039' },
            ], 'ciclo3': [
                { value: 'navegacion_domestica_internacional', text: 'Navegación Doméstica e Internacional(Proximamente...)', esquema: '049' },
                { value: 'sistemas_y_componentes_aeronaves', text: 'Sistemas y Componentes de Aeronaves(Proximamente...)', esquema: '049' },
                { value: 'administracion', text: 'Administración(Proximamente...)', esquema: '049' },
                { value: 'mercancias_peligrosas', text: 'Mercancías Peligrosas(Proximamente...)', esquema: '045' },
                { value: 'etica', text: 'Ética(Proximamente...)', esquema: '040' },
                { value: 'metereologia2', text: 'Metereología II(Proximamente...)', esquema: '040' },
                { value: 'performance_aeronaves2', text: 'Performance de Aeronaves II(Proximamente...)', esquema: '039' },
                ...
                { value: 'mercadotecnia', text: 'Mercadotecnia(Proximamente...)', esquema: '040' },
                { value: 'comportamiento_organizacional', text: 'Comportamiento Organizacional en Aviación(Proximamente...)', esquema: '040' },
                { value: 'operaciones_piloto_comercial', text: 'Operaciones de Piloto Comercial(Proximamente...)', esquema: '039' },
            ], 'ciclo6': [
                { value: 'administracion_operaciones', text: 'Administración de Operaciones(Proximamente...)', esquema: '039' },
                { value: 'investigacion_mercados', text: 'Investigación de Mercados(Proximamente...)', esquema: '045' },
