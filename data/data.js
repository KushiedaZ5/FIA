const dataCarreras = {
    ...
    'arquitectura': {
        ...
        ciclos: {
            'ciclo1': [
                ...
                { value: 'exp_arq3', text: 'Expresión Arquitectónica 3', esquema: '038', creditos: 3 },
                { value: 'estruc1_arq', text: 'Estructuras 1(Proximamente...)', esquema: '038', creditos: 3 },
                { value: 'taller3_arq', text: 'Taller 3', esquema: '127', creditos: 8 },
                { value: 'fisica1', text: 'Física General I', esquema: '040', creditos: 4 },
            ],
            'ciclo4': [
            ...
            'ciclo5': [
                { value: 'const3', text: 'Construcción 3', esquema: '129', creditos: 4 },
                { value: 'urb1', text: 'Urbanismo I', esquema: '127', creditos: 4 },
                { value: 'bio1', text: 'Diseño Bioclimático I', esquema: '038', creditos: 3 },
                { value: 'taller5_arq', text: 'Taller 5', esquema: '127', creditos: 8 },
                { value: 'hist1', text: 'Historia de la Arquitectura I', esquema: '038', creditos: 3 },
    ...
    'aeronautica': {
        ...
        ciclos: {
            'ciclo1': [
                { value: 'fisica1', text: 'Física General I(Proximamente...)', esquema: '040', creditos: 4 },
                { value: 'matematica1', text: 'Matemática I(Proximamente...)', esquema: '041', creditos: 4 },
                ...
                { value: 'fisica2', text: 'Física General II', esquema: '040', creditos: 4 },
                { value: 'matematica2', text: 'Matemática II', esquema: '041', creditos: 4 },
                { value: 'operaciones_piloto_privado', text: 'Operaciones de Piloto Privado', esquema: '055', creditos: 5 },
                { value: 'aerodinamica', text: 'Aerodinámica', esquema: '038', creditos: 4 },
                { value: 'factores_humanos_aviacion', text: 'Factores Humanos en Aviación', esquema: '045', creditos: 2 },
                { value: 'performance_aeronaves1', text: 'Performance de Aeronaves I', esquema: '045', creditos: 2 },
                { value: 'ingles2', text: 'Inglés 2', esquema: '039', creditos: 1 },
            ], 'ciclo3': [
                { value: 'navegacion_domestica_internacional', text: 'Navegación Doméstica e Internacional', esquema: '045', creditos: 4 },
                { value: 'sistemas_y_componentes_aeronaves', text: 'Sistemas y Componentes de Aeronaves', esquema: '038', creditos: 4 },
                ...
                { value: 'metereologia2', text: 'Metereología II', esquema: '045', creditos: 3 },
                { value: 'performance_aeronaves2', text: 'Performance de Aeronaves II', esquema: '045', creditos: 2 },
                { value: 'regulaciones_2', text: 'Regulaciones Aéreas II(Proximamente...)', esquema: '039', creditos: 2 },
            ], 'ciclo4': [
                { value: 'estadistica_probabilidades', text: 'Estadística y Probabilidades', esquema: '041', creditos: 4 },
                ...
                { value: 'administracion_logistica', text: 'Administración Logística', esquema: '045', creditos: 4 },
                { value: 'contabilidad_general', text: 'Contabilidad General', esquema: '038', creditos: 4 },
                { value: 'mercadotecnia', text: 'Mercadotecnia', esquema: '045', creditos: 4 },
                { value: 'comportamiento_organizacional', text: 'Comportamiento Organizacional en Aviación', esquema: '045', creditos: 3 },
                { value: 'operaciones_piloto_comercial', text: 'Operaciones de Piloto Comercial', esquema: '045', creditos: 3 },
            ], 'ciclo6': [
                { value: 'administracion_operaciones', text: 'Administración de Operaciones', esquema: '038', creditos: 4 },
                { value: 'investigacion_mercados', text: 'Investigación de Mercados', esquema: '045', creditos: 4 },
                { value: 'operaciones_despacho_aereo', text: 'Operaciones de Despacho Aéreo', esquema: '045', creditos: 4 },
                { value: 'costos_presupuestos', text: 'Costos y Presupuestos', esquema: '038', creditos: 3 },
                { value: 'sms_i', text: 'Sistema de Gestión de Seguridad Operacional I (SMS-I)', esquema: '038', creditos: 3 },
            ]
        }
    }
};